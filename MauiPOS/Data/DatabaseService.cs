...
namespace MauiPOS.Data
{
    public class DatabaseService : IAsyncDisposable
    {
        ...
        {
            var dbPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "MauiPOS_Db.db3");
            ...
            Task.Run(InitializeDatabase).GetAwaiter().GetResult(); // Synchronous for simplicity; see notes below
        }
        ...
        private async Task SeedDataAsync()
        {
            ...
            if (firstCategory != null) return; // DB has been seeded
        ...
        {
            await InitializeDatabase(); // Ensure initialization before query
